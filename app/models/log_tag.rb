class LogTag < ActiveRecord::Base
  ...
  def self.tag_create(unit = "day", date_from_str = nil, date_to_str = nil, profil = nil, order = "time",  page = 1, max = 50)
  ...
  def self.tag_delete(unit = "day", date_from_str = nil, date_to_str = nil, profil = nil, order = "time",  page = 1, max = 50)
    select_clause = "count(id) total"
    from_clause = "" 
  ...
  def self.tag_create_by_notice(unit = "day", date_from_str = nil, date_to_str = nil, profil = nil, order = "time",  page = 1, max = 50)
  ...
  def self.tag_delete_by_notice(unit = "day", date_from_str = nil, date_to_str = nil, profil = nil, order = "time",  page = 1, max = 50)
    select_clause = "l.object_uid notice_id, count(id) total"
    from_clause = "" 
  ...
  def self.tag_create_by_liste(unit = "day", date_from_str = nil, date_to_str = nil, profil = nil, order = "time",  page = 1, max = 50)
  ...
  def self.tag_delete_by_liste(unit = "day", date_from_str = nil, date_to_str = nil, profil = nil, order = "time",  page = 1, max = 50)
    select_clause = "l.object_uid liste_id, count(id) total"
    from_clause = "" 
