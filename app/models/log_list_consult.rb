class LogListConsult < ActiveRecord::Base
  
  def self.total_liste_create(unit = "day", date_from_str = nil, date_to_str = nil, profil = nil, order = "time",  page = 1, max = 50)
    
    select_clause = "count(id) total"
    from_clause = ""
    where_clause = "create_delete = 1"
    group_by_clause = ""
  ...
  def self.total_liste_consult(unit = "day", date_from_str = nil, date_to_str = nil, profil = nil, order = "time",  page = 1, max = 50)
    
    select_clause = "count(id) total"
    from_clause = ""
    where_clause = "create_delete IS NULL"
    group_by_clause = ""
    
    return self.generic_request(select_clause, from_clause, where_clause, group_by_clause, unit, date_from_str, date_to_str, profil, order, page, max)
  end
  
  def self.total_consult_by_list(unit = "day", date_from_str = nil, date_to_str = nil, profil = nil, order = "time",  page = 1, max = 50)
    
    select_clause = "id_list liste_id, title, count(id_list) total"
    from_clause = ""
    where_clause = "create_delete IS NULL"
    group_by_clause = "id_list"
    
    return self.generic_request(select_clause, from_clause, where_clause, group_by_clause, unit, date_from_str, date_to_str, profil, order, page, max)
  end
  
  def self.total_liste_delete(unit = "day", date_from_str = nil, date_to_str = nil, profil = nil, order = "time",  page = 1, max = 50)
    
    select_clause = "count(id) total"
    from_clause = ""
    where_clause = "create_delete = 0"
    group_by_clause = ""
  ...
  def self.generic_request(select_clause, from_clause, where_clause, group_by_clause, unit = "day", date_from_str = nil, date_to_str = nil, profil = nil, order = "time", page = 1, max = 50)
    ...
    requete += " from log_list_consults l "
    ...
    res = LogListConsult.find_by_sql(requete)
    
    total = 0
    count = LogListConsult.find_by_sql("SELECT FOUND_ROWS() as total")
