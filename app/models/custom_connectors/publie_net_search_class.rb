...
class PublieNetSearchClass < ActionController::Base
  ...
  def SearchCollection(_collect, _qtype, _qstring, _start, _max, _qoperator, _last_id, job_id = -1, infos_user=nil, options=nil, _session_id=nil, _action_type=nil, _data = nil, _bool_obj=true)
    ...
    @records = RetrievePublieNet_Single(_last_id, _query, _qtype, _qstring, _qoperator, _type, _coll_list, _alias, _group, _vendor_url, _is_parent, _col_name,_max.to_i, _collect.filter_query, infos_user, options, _availability)
    logger.debug("Storing found results in cached results begin")
    save_in_cache
  end
  
  def RetrievePublieNet_Single(_search_id, _query, _qtype, _qstring, _qoperator, _type, _coll_list, _alias, _group, _vendor_url,  _is_parent, _collection_name,  _max, _filter_query=nil, infos_user=nil, options=nil, _availability=nil)
  ...
  def RetrievePublieNet(_search_id, _query, _qtype, _qstring, _qoperator, _type, _coll_list, _alias, _group, _vendor_url,  _is_parent, _collection_name, _max,filter_query=nil, infos_user=nil,  options=nil, _availability=nil)
    _x = 0
    _y = 0
    _oldset = ""
    _newset = ""
