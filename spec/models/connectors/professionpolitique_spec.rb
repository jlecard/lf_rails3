# generated file
require 'spec_helper'
require 'professionpolitique_search_class.rb'

describe ProfessionpolitiqueSearchClass do
  describe "SearchCollection" do
    without_transactional_fixtures do
      it "should return records (no action_type)" do
        klass = ProfessionpolitiqueSearchClass.new
        collection = Factory(:professionpolitique_collection)
